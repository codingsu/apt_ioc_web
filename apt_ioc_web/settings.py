...
"""
Django settings for apt_ioc_web project.
...
SECRET_KEY = '4ekr#+bfox3t=m&=p71acc1%q8zw)^3250csn$odk0c1mrq!(m'
...
CRONJOBS = [
    ...
    ('* */12 * * *', 'rssspider.checkworkstatus.checkes',[],{}),
]
